...
OPTION =
INCS = -I. -I$(GENDEV)/m68k-elf/include -I$(GENDEV)/m68k-elf/include -Isrc -Ires -I$(GENDEV)/sgdkv1.41/inc -I$(GENDEV)/sgdkv1.41/res
...
LIBS =  -L$(GENDEV)/m68k-elf/lib -L$(GENDEV)/sgdkv1.41/lib -L$(GENDEV)/m68k-elf/lib/gcc/m68k-elf/* -lmd -lnosys 
